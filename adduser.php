...
if($user_det['urole']=='user'){

   $reg -> redirect('404.php');
	 ...
	 else
	 {
		 try{
			...
			if($row['username'] == $uname){
				...
				if($reg -> adduser($fullname,$empid,$desgn,$dept,$uname,$pwd,$urole)){

					$reg -> redirect("adduser.php?success");
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-9 main-chart">
                    ...
                    <h4>Add User</h4>
                  <form name="adduser_form" method="post" action="">
            ...
            else if(isset($_GET['success']))
            {
                 ...
                 <div class="alert alert-success">
                      <i class="glyphicon glyphicon-log-in"></i> &nbsp; User Successfully added
                 </div>
                 <?php } ?>
				...
				<div class="form-group">
		            ...
		            <button class="btn btn-theme btn-block" name="adduser" type="submit">Add User</button>
